...
@NgModule({
  ...
  imports: [BrowserModule, IonicModule.forRoot(), AppRoutingModule,EquiposModule,EditarperfilModule,EditarrutinaModule,registroModule,RegistroRutinaModule, ReactiveFormsModule,recuperarModule,AngularFireAuthModule,ModificarEquipoModule,AgregarLogrosYPartidosModule],
